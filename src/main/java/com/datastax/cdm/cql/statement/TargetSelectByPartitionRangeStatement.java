...
public class TargetSelectByPartitionRangeStatement extends TargetSelectStatement {
    public Logger logger = LoggerFactory.getLogger(this.getClass().getName());

    public TargetSelectByPartitionRangeStatement(IPropertyHelper propertyHelper, EnhancedSession session) {
    ...
    protected String buildStatement() {
        ...
        // we're using the same filters as origin
